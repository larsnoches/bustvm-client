...
import { AuthenticationRequestDto } from '@modules/core/models/auth.model';
...
export class LoginPageComponent {
  ...
  //   return this.loginForm?.get('password2') ?? null;
  // }
  ...
  onSubmitLogin(): void {
    ...
    this.authService.login(authenticationRequestDto).subscribe(
      data => {
        console.log(data);
